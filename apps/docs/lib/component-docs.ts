...
export function Inbox() {
  ...
  },
  {
    ...
    name: "StackNavigator",
    summary: "A controlled stack of mounted views with interruptible push and pop transitions.",
