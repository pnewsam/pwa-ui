        ...
        {renderState.renderedEntries.map((entry, index) => {
          ...
          return (
            <section
              ...
              className={cn(
                "absolute inset-0 min-h-0 overflow-y-auto bg-background outline-none transition-transform duration-[var(--pwa-stack-transition-duration,280ms)] ease-[cubic-bezier(0.32,0.72,0,1)]",
